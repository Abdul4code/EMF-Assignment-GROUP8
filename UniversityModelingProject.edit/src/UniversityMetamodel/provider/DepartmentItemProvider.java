...
/**
 * This is the item provider adapter for a {@link UniversityMetamodel.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider extends NamedEntityItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Department_Building_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Department_Building_feature", "_UI_Department_type"),
				 UniversityMetamodelPackage.Literals.DEPARTMENT__BUILDING,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UniversityMetamodelPackage.Literals.DEPARTMENT__STAFFS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(UniversityMetamodelPackage.Literals.DEPARTMENT__STAFFS,
				 UniversityMetamodelFactory.eINSTANCE.createStaff()));

		newChildDescriptors.add
			(createChildParameter
				(UniversityMetamodelPackage.Literals.DEPARTMENT__STAFFS,
				 UniversityMetamodelFactory.eINSTANCE.createProffessor()));
	}
