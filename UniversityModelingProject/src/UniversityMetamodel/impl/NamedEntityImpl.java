 ...
 * </p>
 * <ul>
 *   <li>{@link UniversityMetamodel.impl.NamedEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NamedEntityImpl extends MinimalEObjectImpl.Container implements NamedEntity {
	...
	protected EClass eStaticClass() {
		return UniversityMetamodelPackage.Literals.NAMED_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UniversityMetamodelPackage.NAMED_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UniversityMetamodelPackage.NAMED_ENTITY__NAME:
				return getName();
		}
